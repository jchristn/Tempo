namespace Tempo.Core.Runtime
{
    ...
    public class ArtifactPythonStepRunner : ArtifactProcessStepRunner
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtifactPythonStepRunner"/> class.
        /// </summary>
        ...
        /// <param name="pythonExecutable">The Python executable to invoke.</param>
        /// <param name="module">The Python module to import.</param>
        /// <param name="function">The module function to invoke.</param>
        ...
        /// <summary>
        /// Builds the <see cref="ProcessStartInfo"/> that launches Python against a generated shim invoking the configured module and function.
        /// </summary>
        /// <param name="scratch">Per-run scratch directory into which the Python shim is written.</param>
