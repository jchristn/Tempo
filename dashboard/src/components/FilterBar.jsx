  ...
  return (
    <div className="filter-bar">
      ...
      <div className="field">
        ...
        <input type="text" value={filters.statusCode || ''} onChange={(e) => update('statusCode', e.target.value)} placeholder="e.g. 500" />
      </div>
      <div className="field">
        <label>Path contains</label>
        <input type="text" value={filters.pathContains || ''} onChange={(e) => update('pathContains', e.target.value)} placeholder="e.g. /flows" />
      </div>
      <div className="field">
