  ...
  return (
    <header className="dashboard-header">
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        <button className="button-ghost" onClick={onToggleSidebar} aria-label="Toggle sidebar" style={{ padding: '0.375rem' }}>
      ...
      <div className="header-actions">
        ...
        <button className="button-ghost" onClick={onToggleTheme} title="Toggle theme" aria-label="Toggle theme">
          {theme === 'dark' ? (
